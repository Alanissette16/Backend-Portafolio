...
//DTO para crear perfil de programador
public class CreateProgramadorRequestDto {
    ...
    //Constructor vacío
    public CreateProgramadorRequestDto() {
    }

    //Constructor con parámetros
    public CreateProgramadorRequestDto(Long usuarioId, String especialidad, String biografia,
            String linkedinUrl, String githubUrl, String sitioWeb,
            BigDecimal tarifa) {
